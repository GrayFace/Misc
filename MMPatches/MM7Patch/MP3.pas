...
const
  RedbookHandle = pptr($F791FC);
  MSSHandle = pptr($F79200);
var
  mp3stream: ptr;
  mp3volume: int;
...
begin
  Result:= 100000; // 20 tracks normally on CD
end;
...
const
  HooksList: array[1..11] of TRSHookInfo = (
    (p: $4D8328; newp: @AIL_redbook_track_info_Hook; t: RSht4),
    (p: $4D832C; newp: @AIL_redbook_play_Hook; t: RSht4),
    (p: $4D8324; newp: @AIL_redbook_stop_Hook; t: RSht4),
    (p: $4D8308; newp: @AIL_redbook_set_volume_Hook; t: RSht4),
    (p: $4D83B4; newp: @AIL_redbook_volume_Hook; t: RSht4),
    (p: $4D8340; newp: @AIL_redbook_stop_Hook; t: RSht4),
    (p: $4D8360; newp: @AIL_redbook_open_drive_Hook; t: RSht4),
    (p: $4D8320; newp: @AIL_redbook_pause_Hook; t: RSht4),
    (p: $4D831C; newp: @AIL_redbook_resume_Hook; t: RSht4),
    (p: $4D8374; newp: @AIL_redbook_tracks_Hook; t: RSht4),
    ()
  );
